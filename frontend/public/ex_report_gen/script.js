// Ensure docx and saveAs are available in the global scope
const { AlignmentType, Document, Packer, Paragraph, TextRun, UnderlineType } = docx;
...
async function fetchData() {
    ...
    try {
        ...
        console.error('Fetch error:', error); // Handle the error appropriately
    ...
    if (Array.isArray(data)) {
        ...
        return null; // Return null or appropriate value indicating incorrect data structure
    }
}
...
// Expose the generate function to the global scope
